...
Write a function named theLongesString that takes in an array of strings and returns the index position of the theLonges string. 
------------------------------------------------------------------------------------------------ */

const theLongesString = (arr) => {
// Solution code here...
let theLonges = '';
return arr.reduce((acc, value, idnx) => {
  if (value.length > theLonges.length) {
    theLonges = value;
    acc = idnx;
  }
  return acc;
...
const firstLetters = (arr) => {
  // Solution code here...
  return arr.map((valueue) => valueue[0]);
};
...
const findHappiness = (arr) => {
  // Solution code here...
  return arr.filter(valueue => valueue.includes(':)'));
};
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(valueue => valueue.substring(1, 4) + valueue.substring(6, 9) + valueue.substring(10, 14));
};
...
const onlyOddChars = (str) => {
  // Solution code here...
  return str.split('').reduce((acc, value, idx) => {
    if (idx % 2 !== 0) {
      acc += `${value}`;
    }
    return acc;
...
Write a function named allnewArr that takes in an array of strings and returns a Boolean indicating whether all those strings contain ":)".
------------------------------------------------------------------------------------------------ */

const allnewArr = (arr) => {
  // Solution code here...
  let newArr = arr.map(value => (value.includes(':)')) ? true : false);
...
describe('Testing challenge 1', () => {
  test('It should return an index position of the theLonges string', () => {
    const strArray1 = ['Ginger', 'Goose', 'Tangerine', 'Rosie', 'Mario', 'Malaki']
    const strArray2 = [];
    const strArray3= ['Ginger']

    expect(theLongesString(strArray1)).toStrictEqual(2);
    expect(theLongesString(strArray2)).toStrictEqual(-1);
    expect(theLongesString(strArray3)).toStrictEqual(0);
  });
});

describe('Testing challenge 2', () => {
  test('It should return the first letter of each valueuement of the array', () => {
...
describe('Testing challenge 6', () => {
  test('It should correctly assess whether all the strings are newArr', () => {
    const words = ['things', 'apple (:)', ':)banana', 'missing that thing', 'cant:)aloupe'];

    expect(allnewArr(words)).toStrictEqual(false);
    expect(allnewArr(['apple (:)', ':)banana', 'cant:)aloupe'])).toStrictEqual(true);
    expect(allnewArr([])).toStrictEqual(true);
  });
});
