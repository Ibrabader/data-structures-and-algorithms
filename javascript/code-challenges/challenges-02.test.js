...
arrTo3rd.push(Math.pow(value,3))
  
});
return arrTo3rd;
};
// raisedToTheThird([2,3,4,5,6,7])
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const mapTwoToThe = (arr) => {
  let arrMap = arr.map(value =>{ return Math.pow(2,value)
